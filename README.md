...
A full-stack platform enabling first responders to read encrypted medical profiles by tapping NFC wristbands — offline and without the app installed. Multi-tenant RBAC supporting Individual, Organisation, and Admin accounts. JWT authentication with OTP-based resets, two-factor authentication, and biometric login.

### BuildBuddy — Real-Time Construction Management Platform
...
- **1st Place** — Software Sprint, DAIRA (2024)
...
- **Admin Head, FCAP** — Led 100+ members at FAST Club of App Development & Programming (2023–2025)
- **Teaching Assistant** — Supported 600+ students across Programming Fundamentals, OOP, Data Structures, Algorithms, and Artificial Intelligence (2022–2025)
